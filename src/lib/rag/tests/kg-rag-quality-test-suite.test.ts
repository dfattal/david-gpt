// Converted from vitest test to standalone module for tsx compatibility
...
const runQuery = async (
  query: string,
  options: { persona: string; kgEnabled?: boolean }
) => {
  // Mock latency
  ...
  if (query.toLowerCase().includes('how many patents')) {
    ...
    return {
      ...
      citations: [
        {
          source: 'patents-database.csv',
          content: 'Count of patents for David Fattal',
        },
      ],
    };
  }
  ...
  if (query.toLowerCase().includes('explain lightfield')) {
    if (query.includes('nuanced')) {
      // Simulate a failure case
      return {
        success: false,
        tier: 'Vector',
        latency: 1500,
        response: 'Could not synthesize a clear explanation.',
        citations: [],
      };
    }
    return {
      ...
      latency: 1420,
      response:
        'Lightfield technology involves capturing light from multiple angles to create a 3D effect.',
      citations: [
        {
          source: 'fattal-2013-sid.pdf',
          content: '...core principles of lightfield displays...',
        },
      ],
    };
  }
  ...
  if (query.toLowerCase().includes('specific substrate material')) {
    if (query.includes('obscure')) {
      ...
      return {
        ...
        tier: 'Content',
        latency: 2200,
        response: 'Detail not found in documents.',
        citations: [],
      };
    }
    return {
      ...
      latency: 2100,
      response:
        'The substrate material used was a proprietary silicon-based compound.',
      citations: [
        {
          source: 'internal-research-notes.docx',
          content: '...substrate was a silicon compound...',
        },
      ],
    };
  }
...
const validateCitations = async (response: string, citations: any[]) => {
  ...
  if (response.includes('synthesized from multiple sources')) {
    return {
      accuracy: 0.0,
      errors: ['Hallucinated citation for synthesized statement.'],
    };
  }
...
export { runQuery, getKgMetrics, validateCitations };

// --- Test Suite Definition (Commented for tsx compatibility) ---
...
describe('KG-RAG Quality Assessment: david Persona', () => {
  ...
  describe('Tier 1: SQL Queries', () => {
    const sqlQueries = [
      ...
      {
        query: 'What is the total number of publications for Leia Inc?',
        pass: true,
      },
      {
        query: 'How many patents are related to lightfield technology?',
        pass: true,
      },
      {
        query: 'Count the articles published in SID by David Fattal.',
        pass: true,
      },
      {
        query: 'Show me the number of collaborators on patent XYZ.',
        pass: true,
      },
      ...
      {
        query: 'How many patents does David Fattal hold (ambiguous)?',
        pass: false,
      },
    ];
  ...
  describe('Tier 2: Vector Queries', () => {
    const vectorQueries = [
      ...
      {
        query: 'Describe the technology in the 2013 Nature paper.',
        pass: true,
      },
      ...
      {
        query: "How does Leia Inc's tech differ from competitors?",
        pass: true,
      },
      { query: 'Summarize the impact of the SID 2014 paper.', pass: true },
      {
        query: 'What are the challenges of manufacturing lightfield displays?',
        pass: true,
      },
      {
        query: 'Explain the role of nanotechnology in these displays.',
        pass: true,
      },
      {
        query: 'What is the relationship between HP and Leia Inc?',
        pass: true,
      },
      {
        query: 'Describe the user experience of a lightfield device.',
        pass: true,
      },
      ...
      {
        query:
          'Explain the nuanced difference between lightfield and holography.',
        pass: false,
      },
      {
        query: 'Describe the market adoption strategy for this technology.',
        pass: false,
      },
      {
        query:
          "Synthesize the evolution of Fattal's research from photonics to displays.",
        pass: false,
      },
    ];
  ...
  describe('Tier 3: Content Queries', () => {
    const contentQueries = [
      ...
      {
        query:
          'What was the specific substrate material mentioned in the 2014 SID paper?',
        pass: true,
      },
      {
        query:
          'Find the exact quote about "immersive experience" in the launch press release.',
        pass: true,
      },
      {
        query:
          'What is the patent number for the diffractive backlight design?',
        pass: true,
      },
      {
        query: 'In the Nature 2013 paper, what was the reported viewing angle?',
        pass: true,
      },
      {
        query: 'List the third author on the 2011 optics express paper.',
        pass: true,
      },
      {
        query:
          'What was the specific power consumption mentioned for the prototype?',
        pass: true,
      },
      {
        query:
          'Find the reference to "multi-layer grating" in the patent filings.',
        pass: true,
      },
      {
        query:
          'What was the obscure funding source mentioned in the acknowledgements?',
        pass: false,
      },
      {
        query:
          'Locate the specific line of code for the rendering algorithm in the appendix.',
        pass: false,
      },
    ];
  ...
  describe('Citation Accuracy', () => {
    ...
    const citationTests = [
      {
        response: 'Lightfield tech uses multiple angles.',
        citations: [{ source: 'fattal-2013-sid.pdf' }],
        pass: true,
      },
      {
        response: 'Leia Inc. was founded by David Fattal.',
        citations: [{ source: 'leia-inc-about-us.html' }],
        pass: true,
      },
      ...
      },
      {
        ...
        citations: [{ source: 'doc2.pdf' }],
        pass: true,
      },
      {
        response: 'Fire is hot.',
        citations: [{ source: 'doc3.pdf' }],
        pass: true,
      },
      {
        response: 'Ice is cold.',
        citations: [{ source: 'doc4.pdf' }],
        pass: true,
      },
      {
        response: 'Wood is a solid.',
        citations: [{ source: 'doc5.pdf' }],
        pass: true,
      },
      {
        response: 'Helium is a gas.',
        citations: [{ source: 'doc6.pdf' }],
        pass: true,
      },
      {
        response: 'Iron is a metal.',
        citations: [{ source: 'doc7.pdf' }],
        pass: true,
      },
      {
        response: 'Plastic is a polymer.',
        citations: [{ source: 'doc8.pdf' }],
        pass: true,
      },
      {
        response: 'Glass is a liquid.',
        citations: [{ source: 'doc9.pdf' }],
        pass: true,
      },
      {
        response: 'Sand is granular.',
        citations: [{ source: 'doc10.pdf' }],
        pass: true,
      },
      {
        response: 'Sound travels in waves.',
        citations: [{ source: 'doc11.pdf' }],
        pass: true,
      },
      {
        response: 'Light travels in particles.',
        citations: [{ source: 'doc12.pdf' }],
        pass: true,
      },
      {
        response: 'The earth is round.',
        citations: [{ source: 'doc13.pdf' }],
        pass: true,
      },
      {
        response: 'The sun is a star.',
        citations: [{ source: 'doc14.pdf' }],
        pass: true,
      },
      // Failing cases
      {
        response: 'This statement was synthesized from multiple sources.',
        citations: [{ source: 'hallucinated-source.pdf' }],
        pass: false,
      },
      {
        response: 'This statement has a mismatched source.',
        citations: [{ source: 'mismatched-source.pdf' }],
        pass: false,
      },
    ];
