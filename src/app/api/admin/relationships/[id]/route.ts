...
export async function PUT(
  ...
  try {
    ...
    if (validatedData.evidenceText !== undefined)
      updateData.evidence_text = validatedData.evidenceText;
    if (validatedData.evidenceDocId !== undefined)
      updateData.evidence_doc_id = validatedData.evidenceDocId;
