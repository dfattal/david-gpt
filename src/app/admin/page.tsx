  ...
  const tabs = [
    {
      ...
      description: 'Add new documents to the corpus',
    },
    {
      id: 'batch',
      name: 'Batch Upload',
      description: 'Upload multiple documents from folders',
    },
    {
      id: 'status',
      name: 'Processing Status',
      description: 'Monitor ongoing document processing',
    },
    {
      id: 'manage',
      name: 'Manage Documents',
      description: 'View and manage existing documents',
    },
  ] as const;
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mt-8">
        ...
        {activeTab === 'status' && <ProcessingStatus refreshKey={refreshKey} />}
        {activeTab === 'manage' && (
          <DocumentList
