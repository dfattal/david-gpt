    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-medium text-green-600">Excellent (0.98s)</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">RAG Execution Time</span>
              <span className="text-sm font-medium text-green-600">Fast (463ms)</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Database Performance</span>
              <span className="text-sm font-medium text-green-600">Optimal (357ms)</span>
            </div>
            <div className="flex items-center justify-between">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Document Corpus Size</span>
              <span className="text-sm font-medium">6 documents</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Knowledge Graph Entities</span>
      ...
      <Card className="p-8 text-center">
        <div className="text-gray-500">
          <div className="text-lg font-medium mb-2">Advanced Analytics Coming Soon</div>
          <div className="text-sm">
            Real-time charts, detailed usage metrics, and comprehensive system monitoring will be implemented in Phase 4
          </div>
        </div>
      </Card>
    </div>
